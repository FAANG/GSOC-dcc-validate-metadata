...
class ExperimentFileConverter(FileConverter):
    local_file_path = f'{root_path}/XMLS'
    ...
    def generate_sample_xml(self):
        ...
        sample_xml.write(f"local_file_path/{self.room_id}_sample.xml",
    ...
    def generate_experiment_xml(self):
        ...
        for record in self.json_to_convert['experiment_ena']:
            ...
            self.parse_faang_experiment(faang_experiment,
                                        experiment_attributes_elt)
        experiment_xml.write(f"local_file_path/{self.room_id}_experiment.xml",
                             pretty_print=True, xml_declaration=True,
                             encoding='UTF-8')
        return 'Success'
    ...
    def generate_run_xml(self):
        ...
        run_xml.write(f"local_file_path/{self.room_id}_run.xml", pretty_print=True,
    ...
    def generate_study_xml(self):
        ...
        study_xml.write(f"local_file_path/{self.room_id}_study.xml", pretty_print=True,
                        xml_declaration=True, encoding='UTF-8')
        return 'Success'
